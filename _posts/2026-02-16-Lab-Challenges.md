---
tittle: "Lab: CTF Challenges"
date: 2026-02-16
categories: [Web Security, Networking, Exploitation, Vulnerability Management]
tags: [CTF, HTB, Try Hack Me, Kali Linux, Cybersecurity,InfoSec]
image: /assets/private-images/CTF.png
...
From TCP/IP to routing basics, this module strengthened my foundation in networking—critical for both attackers and defenders. 🔌 #InfoSec #HackTheBoxAcademy
...
Learning the fundamentals of web applications is key to spotting weaknesses. This module sharpened my skills in HTTP, sessions, and input handling. 💻 #CyberSecurity #HackTheBoxAcademy
...
Through these exercises, I continue to sharpen skills in:
- Penetration testing
